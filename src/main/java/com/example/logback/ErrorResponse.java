...
public class ErrorResponse {
    ...
    /**
     * Controller에서 유효성 검사가 실패한 경우에 대해 Error 를 반환할때 사용한다.
     * @param code ErrorCode Enum 클래스를 넣는다
     * @param errors 유효성 검사에 실패한 필드에 대한 값이 담긴다.
     * @return ErrorResponse 를 반환한다.
     */
    ...
    /**
     * Client의 값이 파라미터의 타입과 일치하지 않는 경우, 숫자를 받을 곳에 문자로 Client 로부터 넘어오는 경우
     * @param ex 서버 내부에서 값을 넣어준다.
     * @return ErrorResponse 를 반환한다.
     */
